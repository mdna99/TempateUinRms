    ...
    <div class="card-wrap">
        <div class="card-body">
            <div class="d-flex align-items-center mb-2">
                ...
                @if($menu->is_homepage == 1)
                <span class="ml-2 badge badge-secondary">Is On Homepage</span>
                @endif
            </div>
            @if($menu->type == 'link')
            <div class="mb-2">
            ...
            <a href="{{ route('cp.main-menus.edit', $menu) }}" class="btn btn-sm btn-light" style="position: absolute; right: 10px; top: 10px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <a href="{{ route('cp.main-menus.submenus.create', $menu) }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Submenu</a>
</div>
<div class="row">
    ...
    <div class="col-md-4">
        <div class="article">
            <div class="article-header">
                ...
                <a href="{{ route('cp.main-menus.submenus.edit', [$menu, $submenu]) }}" class="btn btn-sm btn-primary" style="position: absolute; top: 10px; right: 45px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil-alt"></i></a>
                <form id="form-action" method="POST" action="{{ route('cp.main-menus.submenus.destroy', [$menu, $submenu]) }}" accept-charset="UTF-8">
                    @method('DELETE')
                    @csrf
            ...
            <div class="card-footer bg-whitesmoke px-2">
                <a href="{{ route('cp.main-menus.submenus.show', [$menu, $submenu]) }}" class="btn btn-sm btn-warning w-100"><i class="fa fa-eye"></i> Detail</a>
            </div>
        </div>
    </div>
    @empty
...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <a href="{{ route('cp.main-menus.posts.create', $menu) }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Post</a>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="table-fit">
                                <form id="form-action" method="POST" action="{{ route('cp.main-menus.posts.destroy', [$menu, $post]) }}" accept-charset="UTF-8">
                                    @method('DELETE')
                                    @csrf
                                    ...
                                    <div class="table-links">
                                        ...
                                        <a href="{{ route('cp.main-menus.posts.show', [$menu, $post]) }}">Detail</a>
                                        <div class="bullet"></div>
                                        <a href="{{ route('cp.main-menus.posts.edit', [$menu, $post]) }}">Edit</a>
                                        <div class="bullet"></div>
