...
class MainMenuController extends Controller
{
    ...
    {
        return view('cp.main-menu.index', [
    ...
    {
        return view('cp.main-menu.create', [
    ...
    public function store(Request $request)
    {
        ...
        $menu = Menu::create([
            ...
            'is_homepage' => isset($request->is_homepage) ? 1 : 0,
        ]);
        ...
        return redirect(route('cp.main-menus.index'))
    ...
    public function update(Request $request, $menu_id)
    {
        ...
        return redirect(route('cp.main-menus.show', $menu))
